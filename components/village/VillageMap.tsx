...
export default function VillageMap({ footer }: VillageMapProps) {
  ...
  return (
    <div className="w-full h-full">
      <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 animate-fadeIn" style={{ isolation: 'isolate' }}>
        ...
        <div className="relative rounded-xl bg-green-50">
          <div 
            className="relative w-full aspect-[9/7] p-4 md:p-6"
            style={{
              minHeight: '500px',
            }}
          >
            ...
            {/* Character layer */}
            <div className="absolute inset-0 grid grid-cols-9 grid-rows-7 gap-1.5 p-4 md:p-6" style={{ zIndex: 9999 }}>
              {/* Render characters */}
